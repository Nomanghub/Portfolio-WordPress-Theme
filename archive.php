...
get_header(); ?>
<div class="cf-theme-relative cf-hd-title header-title ken-burn-center" style="background-image:url('<?php echo get_theme_mod('cf_blog_banner_img'); ?>');">
	<div class="cf-bg-overlay-hd-title"></div>
	<div class="container">
		<div class="title-base">
			<hr class="anima" />
			<h1><?php cf_cat_title(); ?></h1>
